...
city_label = tk.Label(root, text="City Name:", font=("Helvetica", 14), bg="grey")
city_label.pack()

city_entry = tk.Entry(root, width=30, font=("Helvetica", 12))
city_entry.pack()

get_weather_button = tk.Button(root, text="Get Weather", command=get_weather, font=("Helvetica", 12), bg="Lightgreen", fg="bLACK")
get_weather_button.pack()

result_label = tk.Label(root, text="", font=("Helvetica", 14), bg="grey")
result_label.pack()
